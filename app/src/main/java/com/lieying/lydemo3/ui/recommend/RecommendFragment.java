package com.lieying.lydemo3.ui.recommend;
...
public class RecommendFragment extends Fragment {
    ...
    RecommendFragment.MyAdapter mAdapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mRecyclerView = view.findViewById(R.id.rv_recommend);
        initView();
        initListener();
        return view;
    }
    ...
    private void initView() {
        ...
        mAdapter = new RecommendFragment.MyAdapter(getActivity());
    ...
    class MyAdapter extends RecyclerView.Adapter<RecommendFragment.MyAdapter.ViewHolder> {
        ...
        @Override
        public RecommendFragment.MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_focus_rv_item, parent, false);


            return new RecommendFragment.MyAdapter.ViewHolder(view);
        }

        @Override
        public void onBindViewHolder(RecommendFragment.MyAdapter.ViewHolder holder, int position) {
